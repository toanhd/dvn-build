...
echo
echo "========= Submitting transaction from a different peer (peer0.moe) which also signs it ========= "
echo
setGlobals 0 2
set -x
peer channel update -f org3_update_in_envelope.pb -c ${CHANNEL_NAME} -o orderer.toanhd.com:7050 --tls --cafile ${ORDERER_CA}
set +x
