...
# properly added to the network previously setup in the dvn tutorial.
#
...
echo
echo "Extend document verification network test"
echo
CHANNEL_NAME="$1"
DELAY="$2"
LANGUAGE="$3"
...
# Invoke chaincode on peer0.hust, peer0.moe, and peer0.org3
echo "Sending invoke transaction on peer0.hust peer0.moe peer0.org3..."
chaincodeInvoke 0 1 0 2 0 3

# Query on chaincode on peer0.org3, peer0.moe, peer0.hust check if the result is 80
...
echo "Querying chaincode on peer0.moe..."
