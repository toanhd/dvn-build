...
# on peer0.hust and peer0.moe, and uprage the chaincode on the
# channel to version 2.0, thus completing the addition of org3 to the
# network previously setup in the dvn tutorial.
#
...
echo "===================== Installing chaincode 2.0 on peer0.hust ===================== "
installChaincode 0 1 2.0
echo "===================== Installing chaincode 2.0 on peer0.moe ===================== "
installChaincode 0 2 2.0

echo "===================== Upgrading chaincode on peer0.hust ===================== "
